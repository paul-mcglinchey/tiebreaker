...
const AddNewButton = (props) => {
    ...
    const { toggleNewClientActive, newClientActive, setFormVisible } = props;

    const handleClick = () => {
        toggleNewClientActive();
