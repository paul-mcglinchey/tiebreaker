  ...
  return (
    <>
      <div className="flex justify-center space-x-1 items-center">
        <button onDoubleClick={() => setEditShiftOpen(true)} type="button" className="flex items-center space-x-1 rounded p-2 uppercase border-2 border-transparent focus:border-gray-500">
          {editing ? (
            <>
