          ...
          <Form className="flex flex-1 flex-col space-y-6 text-gray-200">
            <div className="flex flex-col space-y-3">
              <div className="flex flex-col md:flex-row space-y-4 md:space-x-4 md:space-y-0 items-end">
                ...
                <ListboxSelector label="Start Day" items={weekdaysList} selected={weekdaysList.find(wd => wd._id === values.startDay)} setSelected={(selected) => setFieldValue('startDay', selected)} />
